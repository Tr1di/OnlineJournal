        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenseiId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkCompletions", x => new { x.HomeworkId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_HomeworkCompletions_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HomeworkCompletions_Homeworks_HomeworkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendees", x => new { x.LessonId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_Attendees_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attendees_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkCompletions_StudentId",
